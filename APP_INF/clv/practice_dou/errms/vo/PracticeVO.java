...
package com.clt.apps.opus.esm.clv.practice_dou.errms.vo;
...
public class PracticeVO extends AbstractValueObject {
	...
	public PracticeVO(String ibflag, String pagerows, String edwUpdDt,
			String updDt, String updUsrId, String creDt, String creUsrId,
			String errDesc, String errMsg, String errLvlCd, String errTpCd,
			String langTpCd, String errMsgCd, String s_msg_cd, String s_msg,
			String del_chk) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues() {
		...
		this.hashColumns.put("s_msg_cd", getS_msg_cd());
		this.hashColumns.put("s_msg", getS_msg());
		return this.hashColumns;
	}

	public String getS_msg_cd() {
		return s_msg_cd;
	}

	public void setS_msg_cd(String s_msg_cd) {
		this.s_msg_cd = s_msg_cd;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setS_msg_cd(JSPUtil.getParameter(request, prefix + "s_msg_cd", ""));
		setS_msg(JSPUtil.getParameter(request, prefix + "s_msg", ""));
		setDel_chk(JSPUtil.getParameter(request, prefix + "del_chk", ""));
	}
	...
	public PracticeVO[] fromRequestGrid(HttpServletRequest request,
		...
		try {
			String[] updDt = (JSPUtil.getParameter(request, prefix + "upd_dt",
					length));
			String[] langTpCd = (JSPUtil.getParameter(request, prefix
					+ "lang_tp_cd", length));
			String[] errLvlCd = (JSPUtil.getParameter(request, prefix
					+ "err_lvl_cd", length));
			String[] creDt = (JSPUtil.getParameter(request, prefix + "cre_dt",
					length));
			String[] edwUpdDt = (JSPUtil.getParameter(request, prefix
					+ "edw_upd_dt", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix
					+ "pagerows", length));
			String[] errMsgCd = (JSPUtil.getParameter(request, prefix
					+ "err_msg_cd", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix + "ibflag",
					length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix
					+ "cre_usr_id", length));
			String[] errDesc = (JSPUtil.getParameter(request, prefix
					+ "err_desc", length));
			String[] errMsg = (JSPUtil.getParameter(request,
					prefix + "err_msg", length));
			String[] errTpCd = (JSPUtil.getParameter(request, prefix
					+ "err_tp_cd", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix
					+ "upd_usr_id", length));
			String[] delChk = (JSPUtil.getParameter(request,
					prefix + "del_chk", length));
	...
	public PracticeVO[] getPracticeVOs() {
		PracticeVO[] vos = (PracticeVO[]) models.toArray(new PracticeVO[models
				.size()]);
		return vos;
	}
	...
	public void unDataFormat() {
		...
		this.langTpCd = this.langTpCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errLvlCd = this.errLvlCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.creDt = this.creDt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.edwUpdDt = this.edwUpdDt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errMsgCd = this.errMsgCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.creUsrId = this.creUsrId.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errDesc = this.errDesc.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errMsg = this.errMsg.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errTpCd = this.errTpCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
