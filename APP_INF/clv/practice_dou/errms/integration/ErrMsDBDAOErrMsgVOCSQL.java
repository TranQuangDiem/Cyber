...
*@FileName : ErrMsDBDAOErrMsgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsDBDAOErrMsgVOCSQL implements ISQLTemplate{
	...
	public ErrMsDBDAOErrMsgVOCSQL(){
		...
		query.append("FileName : ErrMsDBDAOErrMsgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
