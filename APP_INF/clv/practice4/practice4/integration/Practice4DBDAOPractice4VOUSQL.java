...
*@FileName : Practice4DBDAOPractice4VOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice4DBDAOPractice4VOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice4DBDAOPractice4VOUSQL(){
		setQuery();
		...
		query.append("FileName : Practice4DBDAOPractice4VOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
