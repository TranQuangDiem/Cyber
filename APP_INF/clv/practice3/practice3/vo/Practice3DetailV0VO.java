...
*@FileName : Practice3DetailV0VO.java
*@FileTitle : Practice3DetailV0VO
*Open Issues :
*Change history :
...
public class Practice3DetailV0VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Practice3DetailV0VO> models = new ArrayList<Practice3DetailV0VO>();
	...
	public Practice3DetailV0VO() {}

	public Practice3DetailV0VO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String loclCurrCd, String invNo, String csrNo, String aproFlg, String custVndrCntCd, String custVndrSeq, String prnrRefNo, String custVndrEngNm, String joStlItmCd, String revExp, String invRevActAmt, String invExpActAmt) {
		this.csrNo = csrNo;
...
/**
	 ...
	 * @param request
	 * @return Practice3DetailV0VO[]
	 */
	public Practice3DetailV0VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Practice3DetailV0VO[]
	 */
	public Practice3DetailV0VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Practice3DetailV0VO model = null;
		...
		return getPractice3DetailV0VOs();
	}
	 ...
	 * @return Practice3DetailV0VO[]
	 */
	public Practice3DetailV0VO[] getPractice3DetailV0VOs(){
		Practice3DetailV0VO[] vos = (Practice3DetailV0VO[])models.toArray(new Practice3DetailV0VO[models.size()]);
		return vos;
	}
