...
*@FileName : Practice3DBDAOTradeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice3DBDAOTradeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice3DBDAOTradeRSQL(){
		setQuery();
		...
		query.append("FileName : Practice3DBDAOTradeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
