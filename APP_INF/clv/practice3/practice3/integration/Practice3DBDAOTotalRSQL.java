...
*@FileName : Practice3DBDAOTotalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice3DBDAOTotalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice3DBDAOTotalRSQL(){
		setQuery();
		...
		query.append("FileName : Practice3DBDAOTotalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select INV.LOCL_CURR_CD, SUM(INV.INV_REV_ACT_AMT) AS INV_REV_ACT_AMT ,SUM(INV.INV_EXP_ACT_AMT) AS INV_EXP_ACT_AMT" ).append("\n"); 
		...
		query.append("		AND INV.ACCT_YRMON BETWEEN REPLACE(@[fr_acct_yrmon],'-','')" ).append("\n"); 
		query.append("		AND REPLACE(@[to_acct_yrmon],'-','')" ).append("\n"); 
