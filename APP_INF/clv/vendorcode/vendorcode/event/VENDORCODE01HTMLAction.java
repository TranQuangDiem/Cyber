...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.clv.vendorcode 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 * - Parsing 한 정보를 Event로 변환, request에 담아 VendorCodeSC로 실행요청<br>
 * - VendorCodeSC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 * @author Diem Tran
...
public class VENDORCODE01HTMLAction extends HTMLActionSupport {
	...
	/**
	 * VENDORCODE01HTMLAction 객체를 생성
	 */
	public VENDORCODE01HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 VendorCodeEvent로 파싱하여 request에 셋팅<br>
