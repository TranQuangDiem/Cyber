...
*@FileName : PracticeDetailVO.java
*@FileTitle : PracticeDetailVO
*Open Issues :
*Change history :
...
public class PracticeDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PracticeDetailVO> models = new ArrayList<PracticeDetailVO>();
	...
	public PracticeDetailVO() {}

	public PracticeDetailVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String aplyEndDt, String aplyStDt, String intgCdValDpSeq, String intgCdValDesc, String intgCdValDpDesc, String intgCdValCtnt, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return PracticeDetailVO[]
	 */
	public PracticeDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PracticeDetailVO[]
	 */
	public PracticeDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PracticeDetailVO model = null;
	 ...
	 * @return PracticeDetailVO[]
	 */
	public PracticeDetailVO[] getPracticeDetailVOs(){
		PracticeDetailVO[] vos = (PracticeDetailVO[])models.toArray(new PracticeDetailVO[models.size()]);
		return vos;
	}
