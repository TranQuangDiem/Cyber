...
*@FileName : Practice2VO.java
*@FileTitle : Practice2VO
*Open Issues :
*Change history :
...
public class Practice2VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Practice2VO> models = new ArrayList<Practice2VO>();
	...
	public Practice2VO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String intgCdUseFlg, String mngTblNm, String ownrSubSysCd, String intgCdLen, String intgCdDatTpNm, String intgCdTpCd, String intgCdDesc, String intgCdNm, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return Practice2VO[]
	 */
	public Practice2VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Practice2VO[]
	 */
	public Practice2VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Practice2VO model = null;
	 ...
	 * @return Practice2VO[]
	 */
	public Practice2VO[] getPractice2VOs(){
		Practice2VO[] vos = (Practice2VO[])models.toArray(new Practice2VO[models.size()]);
		return vos;
	}
