...
*@FileName : Practice2douVO.java
*@FileTitle : Practice2douVO
*Open Issues :
*Change history :
...
public class Practice2douVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Practice2douVO> models = new ArrayList<Practice2douVO>();
	...
	public Practice2douVO() {}

	public Practice2douVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String intgCdUseFlg, String mngTblNm, String ownrSubSysCd, String intgCdLen, String intgCdDatTpNm, String intgCdTpCd, String intgCdDesc, String intgCdNm, String intgCdId) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOwnrSubSysCd(JSPUtil.getParameter(request, prefix + "subSystem", ""));
	 ...
	 */
	public Practice2douVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Practice2douVO[]
	 */
	public Practice2douVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Practice2douVO model = null;
	...
	public Practice2douVO[] getPractice2douVOs(){
		Practice2douVO[] vos = (Practice2douVO[])models.toArray(new Practice2douVO[models.size()]);
		return vos;
	}
