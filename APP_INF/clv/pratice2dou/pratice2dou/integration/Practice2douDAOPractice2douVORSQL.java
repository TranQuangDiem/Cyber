...
*@FileName : Practice2douDAOPractice2douVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2douDAOPractice2douVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPractice2douVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPractice2douVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if(${ownr_sub_sys_cd}!=''||${intg_cd_id}!='')" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${ownr_sub_sys_cd}!='')" ).append("\n"); 
		query.append("OWNR_SUB_SYS_CD like '%' ||@[ownr_sub_sys_cd] ||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${ownr_sub_sys_cd}!=''&&${intg_cd_id}!='')" ).append("\n"); 
		query.append("AND" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${intg_cd_id}!='')" ).append("\n"); 
		query.append("INTG_CD_ID like '%' ||@[intg_cd_id] ||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
