...
*@FileName : Practice2douDAOPractice2douVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2douDAOPractice2douVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPractice2douVODSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPractice2douVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
