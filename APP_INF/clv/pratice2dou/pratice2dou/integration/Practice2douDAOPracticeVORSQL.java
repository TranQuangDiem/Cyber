...
public class Practice2douDAOPracticeVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPracticeVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPracticeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
