...
*@FileName : Practice2douDAOPracticeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2douDAOPracticeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPracticeRSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPracticeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND	UPD_USR_ID = @[intg_cd_id]" ).append("\n");
