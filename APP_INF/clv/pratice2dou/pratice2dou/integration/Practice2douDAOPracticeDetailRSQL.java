...
*@FileName : Practice2douDAOPracticeDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2douDAOPracticeDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPracticeDetailRSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPracticeDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
