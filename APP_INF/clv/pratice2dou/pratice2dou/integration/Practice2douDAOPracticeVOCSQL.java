...
*@FileName : Practice2douDAOPracticeVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2douDAOPracticeVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2douDAOPracticeVOCSQL(){
		setQuery();
		...
		query.append("FileName : Practice2douDAOPracticeVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	TO_DATE(@[aply_end_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	TO_DATE(@[aply_st_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	@[intg_cd_val_dp_seq]" ).append("\n"); 
		query.append(",	@[intg_cd_val_desc]" ).append("\n"); 
		query.append(",	@[intg_cd_val_dp_desc]" ).append("\n"); 
		query.append(",	@[intg_cd_val_ctnt]" ).append("\n"); 
